...
installed separately. Note the version currently hosted on the R project
website is outdated and will not work. As described
[here](http://thecoatlessprofessor.com/programming/rcpp-rcpparmadillo-and-os-x-mavericks-lgfortran-and-lquadmath-error/),
a newer version can be installed opening a terminal and executing:
...
computer, and they should be run within the `RProjectTemplate` directory.
